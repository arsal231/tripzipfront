...
const [showchilderenlist,setShowChilderenList] = useState(false);
...
const BookNow=()=>{
    ...
    alert('Book Now is ok');
           ...
           // (selectedPlace3 ?  localStorage.setItem('stop_3', JSON.stringify(selectedPlace3)) :   null  )
           ...
           //localStorage.setItem('selectedPlace3', JSON.stringify(selectedPlace3));
           ...
           //(selectedPlace3 ?  localStorage.setItem('stop_3', JSON.stringify(selectedPlace3)) :   localStorage.removeItem('stop_3')  )
           //(selectedPlace4 ?  localStorage.setItem('stop_4', JSON.stringify(selectedPlace4)) :   localStorage.removeItem('stop_4')  ) 
        //    (selectedPlace5 ?  localStorage.setItem('stop_5', JSON.stringify(selectedPlace3)) :   localStorage.removeItem('stop_5')  ) 
        //    (selectedPlace6 ?  localStorage.setItem('stop_6', JSON.stringify(selectedPlace3)) :   localStorage.removeItem('stop_6')  )  
        //    (selectedPlace7 ?  localStorage.setItem('stop_7', JSON.stringify(selectedPlace3)) :   localStorage.removeItem('stop_7')  ) 
           
          // localStorage.setItem('pickUpDate', JSON.stringify(pickUpDate));
           // localStorage.setItem('timevalue', JSON.stringify(timevalue));

        //    (infantvalue ?  localStorage.setItem('infantvalue', JSON.stringify(infantvalue)) :   localStorage.removeItem('infantvalue')  ) 
        //    localStorage.setItem('passengervalue', JSON.stringify(passengervalue));
          
        //    (childerenvalue ?  localStorage.setItem('childerenvalue', JSON.stringify(childerenvalue)) :   localStorage.removeItem('childerenvalue')  ) 
...
<div className="col-md-12 col-lg-6">
    <div className="booking-form">
        ...
        <form action="#">
        <div style={{height:'425px',minHeight:'427px',overflowX:'hidden',scrollbarWidth: 'none'}}>
 ...
 {(selectedPlace) ? selectedPlace : ''}
         ...
         {(selectedPlace2) ? selectedPlace2 : ''}
            ...
            <label style={{display:'block'}}>Stop 7 
            </label>
                        <input
                        ref={ref7}
                            type="text"
            ...
            <div className="col-lg-6 pickupdatecls">
                ...
                <input type="date" className="form-control date-picker" placeholder="DD/MM/YY" onChange={(e)=>setPickUpDate(e.target.value)} />
            ...
            <input type="text" className="form-control "    placeholder={timevalue}  onClick={()=>setShowTimeList(true)} />
        
            <i className="far fa-clock"></i>
            </div>
            {(showtimelist) ?  
            <ul className="passndgercls" >
            
                {timeList.map((item) => ( 
                    <li onClick={()=>selectTimeValue(item)}> {item} </li>
                ))} 
            </ul>
            :''}
            </div>
                ...
                (showReturn) ? 
                        <div className="col-lg-6 pickupdatecls">
                            <div className="form-group">
                                ...
                                <input type="date" className="form-control date-picker" placeholder="DD/MM/YY" onChange={(e)=>setReturnDate(e.target.value)} />
                                <i className="far fa-calendar-days"></i>
                            </div>
                        </div>
        ...
        
        {
            ...
            <input type="text" className="form-control time-picker" placeholder={passengervalue}  onClick={()=>setShowPassengerList(true)}/>
            <i className="far fa-user"></i>
            </div> 
            {(showpassengerlist) ?  
            <ul className="passndgercls" >
                {numbersList.map((item) => ( 
                    <li onClick={()=>selectPasswnerValue(item)}> {item} </li>
                ))}
            </ul>
            :''}
            ...
            <label>Children </label>
                <input type="text" className="form-control time-picker" placeholder={childerenvalue}  onClick={()=>setShowChilderenList(true)}/>
            ...
            <ul className="passndgercls" >
                {numbersList.map((item) => ( 
                    <li onClick={()=>selectChilderenValue(item)}> {item} </li>
                ))}
            ...
            <div className="col-lg-6">
                <div className="form-group">
                <label>Infants </label>
                    <input type="text" className="form-control time-picker" placeholder={infantvalue}  onClick={()=>setShowInfantList(true)}/>
                ...
                <ul className="passndgercls" >
                    ...
                    {numbersList.map((item) => ( 
                        <li onClick={()=>selectInfantValue(item)}> {item} </li>
                    ))}
                </ul>
                :''}
            </div>
            ...
            <div className="col-lg-6">
                    <div className="form-group">
                        ...
                        <div className="form-check form-switch" style={{marginTop: '16px'}}>
                            <input className="form-check-input" name="privacy-setting" value="4" type="checkbox" 
                            role="switch" id="privacy-setting-4" 
                            checked={isChecked} // Set the checked attribute based on state
                            onChange={handleCheckboxChange}
                            />
                            <label className="form-check-label" for="privacy-setting-4">Return Ride</label>
                            </div>
                    </div>
                </div>
        <div>&nbsp;</div>
